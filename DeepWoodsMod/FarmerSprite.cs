    ...
    class FarmerSprite : StardewValley.FarmerSprite
    {
        ...
        private AnimationFrame FixAnimationFrame(AnimationFrame animationFrame)
        {
            return new AnimationFrame(
                ...
                animationFrame.secondaryArm, 
                animationFrame.flip,
                animationFrame.frameStartBehavior,
                false);
            /*
            return new AnimationFrame(
                animationFrame.frame, 
                ...
                animationFrame.secondaryArm, 
                animationFrame.flip, 
                FixAnimationFrameBehavior(animationFrame.frameEndBehavior), 
                animationFrame.behaviorAtEndOfFrame);*/
        }
